...
async def rsa_encrypt(
    ...
    rsa = RSA()
    load_key(rsa, "load_public_key", await key_file.read(), "файл публічного ключа")
...
async def rsa_decrypt(
    ...
    rsa = RSA()
    load_key(rsa, "load_private_key", await key_file.read(), "файл приватного ключа")
...
async def dsa_sign_text(
    ...
    dsa = DSA()
    load_key(dsa, "load_private_key", await key_file.read(), "файл приватного ключа")
...
async def dsa_verify_text(
    ...
    dsa = DSA()
    load_key(dsa, "load_public_key", await key_file.read(), "файл публічного ключа")
